...
namespace RefRegister.Controllers
{
    public class ArenasController : Controller
    {
        ...
        public ArenasController(RefRegisterContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,ContactName,Phonenumber,Email")] Arena arena)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,ContactName,Phonenumber,Email")] Arena arena)
        {
            if (id != arena.Id)
            {
                return NotFound();
